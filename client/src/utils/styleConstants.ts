export const LAYOUT_CLASSES = {
  ...
  // desktop-sheet-center перебивает items-end и ужимает контейнер на md+ —
  // bottom-sheet превращается в центрированный диалог. Правила в mobile.css.
  modal: "absolute inset-0 z-[150] bg-zinc-900/50 backdrop-blur-sm flex items-end desktop-sheet-center animate-in fade-in",
